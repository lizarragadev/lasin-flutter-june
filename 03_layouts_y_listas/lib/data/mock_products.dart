import 'package:layouts_y_listas/models/product.dart';

const List<Product> mockProducts = [
  Product(
      id: "1",
      name: "Teclado Mecánico RGB",
      description: "Teclado mecánico premium con interrruptores táctiles silenciosos y retroiluminación RGB personalizable.",
      price: 89.99,
  ...
  Product(
      ...
      description: "Auriculares inalámbricos con cancelación activa de ruido, sonido envolvente y batería de larga duración.",
      price: 199.99,
  ...
  Product(
      ...
      description: "Reloj inteligente con monitor de frecuencia cardíaca, GPS integrado y resistencia al agua para actividades deportivas.",
      price: 129.99,
  ...
  Product(
      ...
      description: "Ratón de alta presición con sensor y diseño ergonómico para largas sesiones de juego, con iluminación RGB personalizable.",
      price: 49.99,
  ...
  Product(
      ...
      description: "Bateria externa de 20000 mAh recargable mediante luz solar. Ideal para viajes, campamentos y exteriores.",
      price: 39.99,
